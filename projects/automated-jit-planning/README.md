...
### Milk Run Routes Overlaid on Plant Layout

The orange paths below show the actual optimised delivery routes mapped back onto the physical plant — visual proof that every route generated by the engine is physically valid and respects real aisle constraints.
